<template>
    <div class="container mx-auto p-4">
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div v-for="category in topCategories" :key="category.idCategory" class="category-card relative pb-2/3 hover:cursor-pointer hover:opacity-75">
      ...
      <div class="grid grid-cols-9 gap-4">
        <div v-for="category in additionalCategories" :key="category.idCategory" class="flex flex-col items-center hover:cursor-pointer ease-in-out transform hover:translate-y-1 hover:opacity-75 group">
